	...
	public static void getsetData(String Testcasenumber, String Description,String Execute) throws IOException, InterruptedException, AWTException {
		...
		if(Execute.contains("YES")){
			...
			case "TC007" :
				...
				break;
			case "TC008" :
				new Byo().buildandprice(Testcasenumber).comparevehiclelist(Testcasenumber).selecttrims(Testcasenumber).selectfromtrimarry(Testcasenumber).Buildaccessories(Testcasenumber).Buildsummarycomapre(Testcasenumber).Requestaquote(Testcasenumber);
				break;
			case "TC009" :
				new Byo().buildandprice(Testcasenumber).comparevehiclelist(Testcasenumber).selecttrims(Testcasenumber).selectfromtrimarry(Testcasenumber).Buildaccessories(Testcasenumber).Buildsummarycomapre(Testcasenumber).Requestaquote(Testcasenumber);
				break;
			...
			case "TC013" :
				...
				break;
			case "TC014" :
				new Byo().buildandprice(Testcasenumber).comparevehiclelist(Testcasenumber).selecttrims(Testcasenumber).selectfromtrimarry(Testcasenumber).NexofuelBuildaccessories(Testcasenumber).Buildsummarycomapre(Testcasenumber).Requestaquote(Testcasenumber);
				break;
			case "TC015" :
				new Byo().buildandprice(Testcasenumber).comparevehiclelist(Testcasenumber).selecttrims(Testcasenumber).selectfromtrimarry(Testcasenumber).Buildaccessories(Testcasenumber).Buildsummarycomapre(Testcasenumber).Requestaquote(Testcasenumber);
				break;
			...
			case "TC018" :
				...
				break;
			case "TC019" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).tucson2022(Testcasenumber);
				break;
			case "TC020" :
				new Byo().buildandprice(Testcasenumber).comparevehiclelist(Testcasenumber).selecttrims(Testcasenumber).selectfromtrimarry(Testcasenumber).Buildaccessories(Testcasenumber).Buildsummarycomapre(Testcasenumber).Requestaquote(Testcasenumber);
				break;
			...
			case "TC025" :
				...
				break;
			case "TC026" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).offerSectionVerification(Testcasenumber);
				break;
			case "TC027" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).verifyVlpHyundaiAwards(Testcasenumber);
				break;
			case "TC028" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).offersRaq(Testcasenumber);
				break;
			case "TC029" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).verifyVlpHyundaiDiff(Testcasenumber);
				break;
			case "TC030" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).offersRaq(Testcasenumber);
				break;
			...
			case "TC033" :
				...
				break;
			case "TC034" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).offerSectionVerificationWithLease(Testcasenumber);
				break;
			case "TC035" :
				new Vlp_New().clickVehicleNav(Testcasenumber).selectVehicle(Testcasenumber).offerSectionVerificationWithLease(Testcasenumber);
				break;
