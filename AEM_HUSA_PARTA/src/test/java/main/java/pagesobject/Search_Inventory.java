...
//		closeWelcomePopup();
		...
		if(driver.findElement(By.xpath(objValue.getProperty("Xpath.SearchInventory")))!=null) {
			...
			enterByXpath(objValue.getProperty("Xpath.ZipField"), "92708", "Zip field");
			sleepTime(50);
			closeWelcomePopup();
			/*closeWelcomePopup();
			closeNotificationPopup();*/
	...
	String selpackage="";
	String selTrim="";
	public Search_Inventory vehicleResult(String Testcasenumber) throws InterruptedException {
		...
		for(int i=1;i<dropdown.size();i++) {
			...
			if(i==2){ 
				if(filterOptions.contains("Trims")) {
					...
					clickByXpathjs(objValue.getProperty("Xpath.TrimDropdown"), "Trim selection");
			...
			if(i==3){
				...
				else {					reportStep("Packages filter option not displayed in Vehicle Results page ", "FAIL", true);
				}
			}*/
			if(i==3){
				if(filterOptions.contains("Exterior Color")) {
					...
					System.out.println("Exterior Dropdown clicked");
			...
			if(i==4){
				if(filterOptions.contains("Interior Color")) {
					...
					js.executeScript("arguments[0].click();", dropdownClick);
					sleepTime(15);
					driver.findElement(By.xpath("//*[@id=\"inventoryVehiclesFilter\"]/div[1]/div/div[6]/div[2]/ul/li[2]/label/div")).click();
					reportStep("Interior color"+selInColo+" color clicked successfully in Vehicle Results page ", "PASS", true);
					System.out.println("Interior Dropdown clicked");
					sleepTime(15);
				}
				else {
					reportStep("Interior color not clicked in Vehicle Results page ", "FAIL", true);
					System.out.println("Interior color not clicked in Vehicle Results page");
				}
			}
...
System.out.println("Dropdown clicked");
        ...
        System.out.println("vehNameResultPrice");
		...
		System.out.println("Interior color : " + selInColo);
	...
	public Search_Inventory vehicleDetails(String Testcasenumber) throws InterruptedException {
        ...
        System.out.println("vehNameDetail : " +vehNameDetail);
...
//		String vehPriceDetail = vehPrice.getText();
		...
		js.executeScript("arguments[0].scrollIntoView(true);",vehExterior);
		String vehExtDetail = vehExterior.getText();
        System.out.println("vehExtDetail"+vehExtDetail);
        ...
        System.out.println("vehIntDetail :" +vehIntDetail);
        ...
        System.out.println("vehPowerDetail :" +vehPowerDetail);
        ...
        System.out.println("vehicleDealerDetail :"+vehDealerDetail);
		...
		if(vehNameResultDealer.equalsIgnoreCase(vehDealerDetail)) {
         ...
         System.out.println("vehicle Result page is matching");
		}
		else {
			reportStep(vehNameResultDealer+" Vehicle Dealer in the vehicle Result page is not matching with the" +vehDealerDetail+ " vehicle Dealer in the Vehicle details page", "FAIL");
			 System.out.println("vehicle Result page is not matching");
		...
		if(selExColo.equalsIgnoreCase(vehExtDetail)) {
          ...
          System.out.println("vehicle Result page is matching with exterior color");
		}
		else {
			...
			System.out.println("Result page is not matching with exterior color");
        ...
        System.out.println("Vehicle Int detail is showing black");
		}
		else {
			...
			System.out.println("Vehicle Int detail is not showing black");
		...
		System.out.println("TC006 Completed");
		return this;
	...
	public Search_Inventory vehicelDetailsLinks(String Testcasenumber) {
		...
		if(vehNameResultPrice.equals(PayCalVehPrice)) {
           ...
           System.out.println("Payment calculator price is matching ");
		}	
		else {
		...
		if(vehNameResultPrice.equals(applyCreditVehPrice)) {
         ...
         System.out.println("credit price is matching");
		}	
		else {
		...
		if(driver.findElement(By.xpath(objValue.getProperty("Xpath.Trimspec"))) != null) {
			...
			if(specsVerify.getText().contains("Packages")) {
				...
				System.out.println("Trim Specs page displayed");
			}
			else {
		...
		System.out.println("clicked on ScheduleTestDrive");
		sleepTime(10);
		switchToLastWindow();
		sleepTime(10);
		...
		if(stdPage.getText().contains("Hyundai Test Drive")) {
			...
			System.out.println("Test Drive page displayed");
		}
		else {
		...
		if(offerSec.getText().contains("Current Offers")) {
			...
			System.out.println("Verified the Savings link");
...
//			clickByXpath(objValue.getProperty("Xpath.OfferClose"), "Saving close");
	...
	public Search_Inventory raqSubmit(String Testcasenumber) throws IOException {
		...
		System.out.println("TC007 Completed");
		return this;
	}
