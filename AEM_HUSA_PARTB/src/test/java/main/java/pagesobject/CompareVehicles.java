...
public class CompareVehicles extends Projectcommonmethodes {
	...
	public CompareVehicles vehicleSelector(String Testcasenumber) throws IOException, InterruptedException {
		...
		WebElement priceValue = driver.findElementByXPath("//input[@data-vbws-compare='" + modelFirst+"']" + "//following::span[2]//following::span[3]//following::span[2]");
		...
		WebElement priceValue1 = driver.findElementByXPath("//input[@data-vbws-compare='" + modelSecond+"']" + "//following::span[2]//following::span[3]//following::span[2]");
		...
		WebElement priceValue2 = driver.findElementByXPath("//input[@data-vbws-compare='" + modelThird+"']" + "//following::span[2]//following::span[3]//following::span[2]");
	...
	public CompareVehicles vehicleComparison(String Testcasenumber) throws InterruptedException {
		closeNotificationPopup();
		sleepTime(20);
		...
		/*Select sel = new Select(driver.findElement(By.xpath(objValue.getProperty("xpath.CompselectYear"))));
		sel.selectByIndex(1);
		sleepTime(5);
		Select selMake = new Select(driver.findElement(By.xpath(objValue.getProperty("xpath.CompselectMake"))));
		selMake.selectByIndex(1);
		sleepTime(5);
		Select selModel = new Select(driver.findElement(By.xpath(objValue.getProperty("xpath.CompselectModel"))));
		selModel.selectByIndex(1);
		sleepTime(5);
		Select selTrim = new Select(driver.findElement(By.xpath(objValue.getProperty("xpath.CompselectTrim"))));
		selTrim.selectByIndex(1);
		sleepTime(5);*/
