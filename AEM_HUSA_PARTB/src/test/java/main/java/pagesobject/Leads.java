...
public class Leads extends Projectcommonmethodes{
	...
	public Leads (RemoteWebDriver driver) {
	...
	public Leads emailVerifyRequestAQuote(String Testcasenumber) throws IOException {
		...
		clickByXpath(objValue.getProperty("xpath.outlookemailVerifyRaq"), "Email Link");
		sleepTime(30);
		WebElement emailName = driver.findElement(By.xpath(objValue.getProperty("xpath.outlookRaqVehName")));
		...
		System.out.println("RAQ TC completed");
		return this;
...
public Leads emailVerifyRequestAQuoteSearchInv(String Testcasenumber) throws IOException {
		...
		//	reportStep(RaqVehName+"Email not received for Request A Quote page", "FAIL", true);
		//}
		System.out.println("Search Inventory TC completed");
		return this;
	...
	public Leads keepMeUpdateLeadForm(String Testcasenumber) throws InterruptedException, IOException {
		...
		System.out.println("Keep Me Updated completed");
		return this;
	...
	public Leads searchInvRaqNegativeFlow(String Testcasenumber) throws IOException, InterruptedException {
		...
		System.out.println("Search Inv TC completed");
		return this;
	}
	...
	public Leads negativeFirstName(String Testcasenumber) throws IOException, InterruptedException {
		...
		if(driver.findElement(By.xpath(objValue.getProperty("xpath.firstName", "FirstName")))!=null)
		{
			...
			sleepTime(10);
			scrollElement(objValue.getProperty("xpath.offerRAQButton"));
	...
	public Leads rateQuoteForm(String Testcasenumber) throws IOException, InterruptedException {
	...
	public Leads outlookMailLogin(String Testcasenumber) throws IOException {
		
		

		try {
			driver.get((prop.getProperty("urlOutlookLogin")));
			driver.manage().window().setSize(new Dimension(1920,1080));
			reportStep("Launch Outlook Mail Login Page", "Pass");
		}
		catch(Exception e) {

			reportStep("Launch Outlook Login Page"+e, "FAIL");
		}
		if(driver.findElement(By.xpath(objValue.getProperty("xpath.outlookSignin", "Outlook SIgn In")))!=null) {
			clickByXpathjs(objValue.getProperty("xpath.outlookSignin"), "Outlook SIgn In");
			sleepTime(10);
			enterByXpath(objValue.getProperty("xpath.outlookEmail"),ReadExcelData.getdata(Testcasenumber,"Email"), "LogInID");
			clickByXpathjs(objValue.getProperty("xpath.outlookNext"), "mailNextButton");
			sleepTime(10);
			enterByXpath(objValue.getProperty("xpath.outlookPassword"),ReadExcelData.getdata(Testcasenumber,"Password"), "mailPassword");
			clickByXpathjs(objValue.getProperty("xpath.outlookNext"), "ButtonSignIn");
			sleepTime(10);
			
			try {
				
				WebElement noEle = driver.findElement(By.xpath(objValue.getProperty("xpath.outlookNoSignin")));
				noEle.click();
				sleepTime(10);
					reportStep("Clicked No Option in Outlook Page", "PASS");
				}
				
			 catch (Exception e) {
				// TODO Auto-generated catch block
				System.out.println("Unable to find Keep sign in  popup");
				e.printStackTrace();
			}
			...
			try {
				...
				WebElement feedBack = driver.findElement(By.xpath(objValue.getProperty("xpath.feedBack")));
				feedBack.click();
				sleepTime(10);
					reportStep("Closed Feedback in Outlook Page", "PASS");
				}
				
			 catch (Exception e) {
				// TODO Auto-generated catch block
				System.out.println("Unable to find Feedback popup");
				e.printStackTrace();
			}
			try {
				
				WebElement gotItEle = driver.findElement(By.xpath(objValue.getProperty("xpath.outlookGotit")));
				gotItEle.click();
				sleepTime(10);
					reportStep("Clicked Got it Option in Outlook Page", "PASS");
				}
				
			 catch (Exception e) {
				// TODO Auto-generated catch block
				System.out.println("Unable to find Got it Option in Outlook Page");
				e.printStackTrace();
			}
		}
		else
		{
			reportStep("Outlook Login ID field not Found", "FAIL");
		}
	...
	public Leads gmailLogin(String Testcasenumber) throws IOException {

		try {
			driver.get((prop.getProperty("urlGmailLogin")));
			reportStep("Launch Gmail Page", "Pass");
		}
		catch(Exception e) {

			reportStep("Launch Gmail Login Page"+e, "FAIL");
		}
		if(driver.findElement(By.xpath(objValue.getProperty("xpath.gmail", "Gmail LogIn ID")))!=null) {
			enterByXpath(objValue.getProperty("xpath.gmail"),ReadExcelData.getdata(Testcasenumber,"Email"), "LogInID");
			clickByXpathjs(objValue.getProperty("xpath.emailNext"), "mailNextButton");
			enterByXpath(objValue.getProperty("xpath.emailPassword"),ReadExcelData.getdata(Testcasenumber,"Password"), "mailPassword");
			clickByXpathjs(objValue.getProperty("xpath.emailNext"), "mailNextButton");
			//clickByXpathjs(objValue.getProperty("xpath.mailButtonSignIn"), "ButtonSignIn");
			sleepTime(10);
			switchToFrameByXpath(objValue.getProperty("xpath.gmailFrame"));
			sleepTime(5);
			clickByXpathjs(objValue.getProperty("xpath.gmailButton"), "Gmail Link");
			sleepTime(10);
			clickByXpathjs(objValue.getProperty("xpath.emailNavButton"), "Gmail Link");
			sleepTime(10);
			switchToLastWindow();
			...
			{
				reportStep("Landed in Gmail Page", "PASS");
			}
			else
			{
				reportStep("Landed in Yahoo Gmail Page", "FAIl");
			}
		}
		else
		{
			reportStep("Gmail Login ID field not Found", "FAIL");
		}
	...
	public Leads mailValidations(String Testcasenumber) throws IOException {
		...
		if(driver.findElement(By.xpath(objValue.getProperty("xpath.outlookemailVerifyRaq", "selectMail")))!=null) 
		{

			clickByXpathjs(objValue.getProperty("xpath.outlookemailVerifyRaq"), "selectMail");
		...
		try
		{
		   ...
		   {			   		   			
				...
				//	clickByXpath(objValue.getProperty("xpath.selecttrimname"),"selecttrimname");
					...
					clickByXpathjs(objValue.getProperty("xpath.selectbuild"),"selectbuild");
					sleepTime(10);
					break;
					}
					else
...

	{
		closeNotificationPopup();
		//sleepTime(10);
		clickByXpathjs(objValue.getProperty("xpath.accessories"),"accessories");
		sleepTime(10);
		//closeWelcomePopup();
		...
		sleepTime(15);
		clickByXpathjs(objValue.getProperty("xpath.finishbuild"),"finishbuild");
		sleepTime(15);
...

	{
		...
		enterByXpath(objValue.getProperty("xpath.firstname"),"Test"," firstname");
		enterByXpath(objValue.getProperty("xpath.lastname"),"Test"," lastname");
		enterByXpath(objValue.getProperty("xpath.raqemail"),"hyundaiautomationtesting@outlook.com","email");
		sleepTime(15);
		clickByXpath(objValue.getProperty("xpath.raq"),"raq");
		/*Thread.sleep(10000);
