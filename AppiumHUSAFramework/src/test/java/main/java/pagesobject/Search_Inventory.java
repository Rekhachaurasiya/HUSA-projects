...
//		sleepTime(5);
		if(driver.findElement(By.xpath(objValue.getProperty("Xpath.SearchInventory")))!=null) {
			...
			//closeWelcomePopup();
			sleepTime(10);
			clickByXpath(objValue.getProperty("Xpath.InventoryFilterBtn"), "Header-Search Inventory");
...
//			closeWelcomePopup();
			...
			clickByXpath(objValue.getProperty("Xpath.InventoryFilterBtn"), "Header-Search Inventory");
			sleepTime(5);
//			WebElement slider = driver.findElement(By.xpath("//*[@id=\"imf-filters-msrp-range\"]"));
//		    Actions action = new Actions(driver);
//		    action.dragAndDropBy(slider, 100, 80).release().build().perform();
//		    slider.click();
		//	enterByXpath(objValue.getProperty("Xpath.Msrpfield"), "1,00,000", "Maximum MSRP");
			...
			System.out.println("MSRP value entered successfully");
			sleepTime(10);
...
//			js.executeScript("arguments[0].scrollIntoView(true);",fuel);
			...
			System.out.println("Fuel check clicked successfully");
			sleepTime(10);
			clickByXpath(objValue.getProperty("Xpath.FilterDoneBtn"), "Filter done");
			reportStep("done clicked successfully", "PASS", true);
		...
		for(int i=1;i<dropdown.size();i++) {
			...
			if(i==4){
				if(filterOptions.contains("Interior Color")) {
					...
					js.executeScript("arguments[0].click();", dropdownClick);
					clickByXpathjs(objValue.getProperty("Xpath.InteriorColorselection"), "Interior selection");
