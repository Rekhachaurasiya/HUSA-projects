...
//	}
	...
	public  FindDealer clickFindDealerButton(String Testcasenumber) {
	...
	public FindDealer searchMoreDealers(String Testcasenumber) 
	{
		...
		{
			List<WebElement> beforeList=new LinkedList<>();
			...
			if(driver.findElement(By.xpath(objValue.getProperty("xpath.btnMoreDealers"))) != null) 
			{
				...
				List<WebElement> afterList=driver.findElementsByXPath((objValue.getProperty("xpath.txtDealersList")));
				afterList.size();
